...
from apps.rooms.views import ReservationCreateView, ReservationDeleteView, ReservationListView, ReservationUpdateView, RoomCreateView, RoomDeleteView, RoomListView, RoomUpdateView
