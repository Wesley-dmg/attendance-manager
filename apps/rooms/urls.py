...
from apps.rooms.views import AdminReservationListView, ReservationCreateView, ReservationDeleteView, ReservationRejectView, ReservationUpdateView, ReservationValidateView, RoomCreateView, RoomDeleteView, RoomListView, RoomUpdateView
