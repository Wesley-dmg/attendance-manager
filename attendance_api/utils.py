...
# #     message = f"Votre code de connexion est : {user.otp_code}"
# #     success, result = send_whatsapp_message(user.phone_number, message)
    
# #     if not success:
# #         print(f"[ERREUR TWILIO] Échec d'envoi OTP à {user.phone_number} : {result}")
# #     else:
# #         print(f"[TWILIO] OTP envoyé à {user.phone_number} (sid={result})")
